...
import com.example.springboot.controller.request.AppointPageRequest;
...
//    新增用户的接口
    @PostMapping("/save")
    public Result save(@RequestBody Appoint obj) {
//        通过@RequestBody将json对象转换为User对象

        appointService.save(obj);
...
//    在编辑时通过id查询的接口,它是update的前提
    ...
    public Result getById(@PathVariable Integer id){
        Appoint obj = appointService.getById(id);
...
//        Borrow obj = categoryService.detail(id);
//        return Result.success();
//    }
// 提交接口
    @PutMapping("/update")
    public Result update(@RequestBody Appoint obj) {
//        通过@RequestBody将json对象转换为User对象
        appointService.update(obj);
        return Result.success();
...
//        appointService.deleteRetById(id);
//        return Result.success();
//    }
...
//        return categoryService.listUsers();原来接口
    @GetMapping("/list")
    public Result list(){
        List<Appoint> list = appointService.list();
        return Result.success(list);

    }
    @GetMapping("/page")
    public Result page(AppointPageRequest appointPageRequest){
        return Result.success(appointService.page(appointPageRequest));

    }
//    @GetMapping("/pageRet")
//    public Result pageRet(BorrowPageRequest borrowPageRequest){
//        return Result.success(appointService.pageRet(borrowPageRequest));
//
//    }
//    @GetMapping("/lineCharts/{timeRange}")
//    public Result lineCharts(@PathVariable String timeRange){
//        return Result.success(appointService.getCountByTimeRange(timeRange));
//    }
