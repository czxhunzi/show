...
import com.example.springboot.anno.Log;
...
public class AdminService implements IAdminService {
    ...
    private static final String PASS_SALT = "abc";
...
//        加密
    ...
    public LoginDTO login(LoginRequest request) {
            ...
            RedisUtils.setCacheObject("library",request.getUsername());
